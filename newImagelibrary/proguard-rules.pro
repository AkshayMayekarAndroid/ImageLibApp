...
-keep public interface com.akshaymayekar.newImagelibrary.OnImageLoadListener {*;}
-keep public interface com.akshaymayekar.newImagelibrary.OnMultipleImageLoadListener {*;}
